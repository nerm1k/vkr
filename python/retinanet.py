...
def detect_objects(image_path, confidence_threshold):
    ...
    cfg.MODEL.WEIGHTS = os.path.join(os.path.dirname(__file__), "model_final_retinanet.pth")
    cfg.MODEL.RETINANET.NUM_CLASSES = 2  # 2 класса: full_container, not_full_container
